...
This folder contains experimental data of cell division times (*Data from Donada et al., 2025*), together with their analysis to obtain the lognormal distribution parameters used in the simulations:
